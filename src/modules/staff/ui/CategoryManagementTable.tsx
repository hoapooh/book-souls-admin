...
interface CategoryManagementTableProps {
	onViewCategory?: (category: ICategory) => void;
...
export function CategoryManagementTable({
	...
	const globalFilterFn = (row: { original: ICategory }, columnId: string, value: string) => {
		...
		return (
			...
			category.id.toLowerCase().includes(searchValue)
		);
	};

	const table = useReactTable({
		data: categoriesData?.result?.items || [],
		columns,
		...
		globalFilterFn,
		rowCount: categoriesData?.result?.totalCount || 0,
				...
				<CardHeader>
					<div className="flex items-center justify-between">
						<div>
							...
							<CardDescription>
								Manage all categories in the system. Total categories:{" "}
								{categoriesData?.result?.totalCount || 0}
							</CardDescription>
						</div>
				...
				<CardContent>
					...
					<div className="flex items-center justify-between space-x-2 py-4">
						<div className="text-sm text-muted-foreground">
							...
							of {categoriesData?.result?.totalCount || 0} categories
						</div>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							action cannot be undone and may affect books assigned to this category.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
